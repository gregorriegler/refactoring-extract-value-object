...
public class EventTest {
    ...
    @Test void
    should_not_create_event_without_name() {
        assertThatThrownBy(
    ...
    @Test void
    should_not_create_event_without_fromDate() {
        assertThatThrownBy(
    ...
    @Test void
    should_not_create_event_without_toDate() {
        assertThatThrownBy(
    ...
    @Test void
    should_not_create_event_with_toDate_before_fromDate() {
        assertThatThrownBy(
